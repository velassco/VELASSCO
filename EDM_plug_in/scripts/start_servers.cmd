rem SET EDM_BIN=O:\edm\v6.0.xxx\output\x64\debug
...
start /min %EDM_BIN%\edmserver.exe -ul10007 -o -w -s9090 -l"%BASE_FOLDER%\db1" -nVELaSSCo -pv
start /min %EDM_BIN%\edmappserver.exe -w -s9090

start /min %EDM_BIN%\edmserver.exe -ul10175 -o -w -s9080 -l"%BASE_FOLDER%\db2" -nVELaSSCo -pv
start /min %EDM_BIN%\edmappserver.exe -w -s9080

start /min %EDM_BIN%\edmserver.exe -ul10176 -o -w -s9070 -l"%BASE_FOLDER%\db3" -nVELaSSCo -pv
