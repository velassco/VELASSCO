...
if ( THRIFT_LIBRARY )
  ...
  if ( THRIFT_LIBRARYNB )
    set( THRIFT_LIBRARIES ${THRIFT_LIBRARIES} ${THRIFT_LIBRARYNB} )
  else()
    message( FATAL "Could not find thriftnb library, use THRIFT_HOME" )
  endif()
else()
  message( FATAL "Could not find thrift library, use THRIFT_HOME" )
endif()
