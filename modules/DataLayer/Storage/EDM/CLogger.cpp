...
/*================================================================================================*/
void CLoggWriter::error(EDMLONG nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
...
/*================================================================================================*/
void CLoggWriter::rstatError(EDMLONG rstat, int nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
...
/*================================================================================================*/
void CLogger::logg(EDMLONG nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
...
/*================================================================================================*/
void CLogger::fatalError(EDMLONG nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
...
/*================================================================================================*/
void CLogger::loggError(EDMLONG nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
...
/*================================================================================================*/
void CLogger::warning(EDMLONG nParams, char *format, ...)
/*================================================================================================*/
{
   char              *params[10];
   va_list           pList;
