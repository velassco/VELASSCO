...
const std::map<int, const char*> _ElementType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(11, _kElementTypeValues, _kElementTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
rvGetThumbnailOfAModel::rvGetThumbnailOfAModel(const rvGetThumbnailOfAModel& other91) {
  status = other91.status;
  report = other91.report;
  imageFile = other91.imageFile;
  __isset = other91.__isset;
}
rvGetThumbnailOfAModel& rvGetThumbnailOfAModel::operator=(const rvGetThumbnailOfAModel& other92) {
  status = other92.status;
  report = other92.report;
  imageFile = other92.imageFile;
...
const char* rvOpenModel::ascii_fingerprint = "07A9615F837F7D0A952B595DD3020972";
const uint8_t rvOpenModel::binary_fingerprint[16] = {0x07,0xA9,0x61,0x5F,0x83,0x7F,0x7D,0x0A,0x95,0x2B,0x59,0x5D,0xD3,0x02,0x09,0x72};
...
rvOpenModel::rvOpenModel(const rvOpenModel& other93) {
  modelID = other93.modelID;
  report = other93.report;
  __isset = other93.__isset;
}
rvOpenModel& rvOpenModel::operator=(const rvOpenModel& other94) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->analyses.resize(_size95);
            uint32_t _i99;
            for (_i99 = 0; _i99 < _size95; ++_i99)
            {
              xfer += iprot->readString(this->analyses[_i99]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t rvGetListOfAnalyses::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("analyses", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter100 = this->analyses.begin(); _iter100 != this->analyses.end(); ++_iter100)
    {
...
rvGetListOfAnalyses::rvGetListOfAnalyses(const rvGetListOfAnalyses& other101) {
  status = other101.status;
  report = other101.report;
  analyses = other101.analyses;
  __isset = other101.__isset;
}
rvGetListOfAnalyses& rvGetListOfAnalyses::operator=(const rvGetListOfAnalyses& other102) {
  status = other102.status;
  report = other102.report;
  analyses = other102.analyses;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->time_steps.resize(_size103);
            uint32_t _i107;
            for (_i107 = 0; _i107 < _size103; ++_i107)
            {
              xfer += iprot->readDouble(this->time_steps[_i107]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t rvGetListOfTimeSteps::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("time_steps", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<double> ::const_iterator _iter108;
    for (_iter108 = this->time_steps.begin(); _iter108 != this->time_steps.end(); ++_iter108)
    {
      xfer += oprot->writeDouble((*_iter108));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
...
rvGetListOfTimeSteps::rvGetListOfTimeSteps(const rvGetListOfTimeSteps& other109) {
  status = other109.status;
  report = other109.report;
  time_steps = other109.time_steps;
  __isset = other109.__isset;
}
rvGetListOfTimeSteps& rvGetListOfTimeSteps::operator=(const rvGetListOfTimeSteps& other110) {
  status = other110.status;
  report = other110.report;
  time_steps = other110.time_steps;
...
const char* MeshInfo::ascii_fingerprint = "6A7B8A30C7FE0D1311743005273ADB0A";
const uint8_t MeshInfo::binary_fingerprint[16] = {0x6A,0x7B,0x8A,0x30,0xC7,0xFE,0x0D,0x13,0x11,0x74,0x30,0x05,0x27,0x3A,0xDB,0x0A};
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (ElementType)ecast111;
          this->__isset.type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
MeshInfo::MeshInfo(const MeshInfo& other112) {
  name = other112.name;
  type = other112.type;
  nVertices = other112.nVertices;
  nElements = other112.nElements;
  meshUnits = other112.meshUnits;
  meshColor = other112.meshColor;
  __isset = other112.__isset;
}
MeshInfo& MeshInfo::operator=(const MeshInfo& other113) {
  name = other113.name;
  type = other113.type;
...
const char* rvGetListOfMeshes::ascii_fingerprint = "407F9FDBF23CED94CA64CE354EAF4922";
const uint8_t rvGetListOfMeshes::binary_fingerprint[16] = {0x40,0x7F,0x9F,0xDB,0xF2,0x3C,0xED,0x94,0xCA,0x64,0xCE,0x35,0x4E,0xAF,0x49,0x22};
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->meshInfos.resize(_size114);
            uint32_t _i118;
            for (_i118 = 0; _i118 < _size114; ++_i118)
            {
              xfer += this->meshInfos[_i118].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t rvGetListOfMeshes::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("meshInfos", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    std::vector<MeshInfo> ::const_iterator _iter119;
    for (_iter119 = this->meshInfos.begin(); _iter119 != this->meshInfos.end(); ++_iter119)
    {
...
rvGetListOfMeshes::rvGetListOfMeshes(const rvGetListOfMeshes& other120) {
  status = other120.status;
  report = other120.report;
  meshInfos = other120.meshInfos;
  __isset = other120.__isset;
}
rvGetListOfMeshes& rvGetListOfMeshes::operator=(const rvGetListOfMeshes& other121) {
