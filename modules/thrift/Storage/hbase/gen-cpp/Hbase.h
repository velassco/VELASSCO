...
class HbaseConcurrentClient : virtual public HbaseIf {
 ...
 public:
  ...
  void append(std::vector<TCell> & _return, const TAppend& append);
  int32_t send_append(const TAppend& append);
  void recv_append(std::vector<TCell> & _return, const int32_t seqid);
  bool checkAndPut(const Text& tableName, const Text& row, const Text& column, const Text& value, const Mutation& mput, const std::map<Text, Text> & attributes);
  int32_t send_checkAndPut(const Text& tableName, const Text& row, const Text& column, const Text& value, const Mutation& mput, const std::map<Text, Text> & attributes);
