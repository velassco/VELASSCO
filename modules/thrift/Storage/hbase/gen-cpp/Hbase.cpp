...
void HbaseConcurrentClient::append(std::vector<TCell> & _return, const TAppend& append)
{
  int32_t seqid = send_append(append);
  recv_append(_return, seqid);
}

int32_t HbaseConcurrentClient::send_append(const TAppend& append)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("append", ::apache::thrift::protocol::T_CALL, cseqid);
...
void HbaseConcurrentClient::recv_append(std::vector<TCell> & _return, const int32_t seqid)
{
...
bool HbaseConcurrentClient::checkAndPut(const Text& tableName, const Text& row, const Text& column, const Text& value, const Mutation& mput, const std::map<Text, Text> & attributes)
{
  int32_t seqid = send_checkAndPut(tableName, row, column, value, mput, attributes);
  return recv_checkAndPut(seqid);
}

int32_t HbaseConcurrentClient::send_checkAndPut(const Text& tableName, const Text& row, const Text& column, const Text& value, const Mutation& mput, const std::map<Text, Text> & attributes)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("checkAndPut", ::apache::thrift::protocol::T_CALL, cseqid);
...
bool HbaseConcurrentClient::recv_checkAndPut(const int32_t seqid)
{
