...
void ElementType::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ElementType(";
  out << "shape=" << to_string(shape);
  out << ", " << "num_nodes=" << to_string(num_nodes);
  out << ")";
}
...
void Vertex::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Vertex(";
  out << "id=" << to_string(id);
  out << ", " << "x=" << to_string(x);
...
void Element::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Element(";
  out << "id=" << to_string(id);
  out << ", " << "nodes_ids=" << to_string(nodes_ids);
  out << ")";
}
...
void ElementAttrib::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ElementAttrib(";
  out << "id=" << to_string(id);
...
void ElementGroup::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ElementGroup(";
  out << "id=" << to_string(id);
...
void MeshInfo::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "MeshInfo(";
  out << "name=" << to_string(name);
  out << ", " << "elementType=" << to_string(elementType);
  out << ", " << "nVertices=" << to_string(nVertices);
  out << ", " << "nElements=" << to_string(nElements);
  out << ", " << "meshUnits=" << to_string(meshUnits);
  out << ", " << "meshColor=" << to_string(meshColor);
  out << ", " << "meshNumber=" << to_string(meshNumber);
  out << ", " << "coordsName=" << to_string(coordsName);
  out << ")";
}
...
void Mesh::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Mesh(";
  out << "name=" << to_string(name);
  out << ", " << "numberOfVertices=" << to_string(numberOfVertices);
...
void ResultInfo::printTo(std::ostream& out) const {
  ...
  out << "name=" << to_string(name);
  out << ", " << "type=" << to_string(type);
  out << ", " << "numberOfComponents=" << to_string(numberOfComponents);
  out << ", " << "componentNames=" << to_string(componentNames);
  out << ", " << "location=" << to_string(location);
  out << ", " << "gaussPointName=" << to_string(gaussPointName);
  out << ", " << "coordinatesName=" << to_string(coordinatesName);
  out << ", " << "units=" << to_string(units);
  out << ", " << "resultNumber=" << to_string(resultNumber);
  out << ")";
}
...
void ResultOnVertex::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ResultOnVertex(";
  out << "id=" << to_string(id);
  out << ", " << "value=" << to_string(value);
  out << ", " << "bvalue=" << to_string(bvalue);
  out << ")";
}
...
void Triangle::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "Triangle(";
  out << "nodes=" << to_string(nodes);
  out << ")";
...
void rvGetElementOfPointsInSpace::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvGetBoundaryOfLocalMesh::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvGetResultFromVerticesID_A::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetResultFromVerticesID_A(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "nVertices=" << to_string(nVertices);
  out << ", " << "nValuesPrVertex=" << to_string(nValuesPrVertex);
  out << ", " << "vertexIDs=" << to_string(vertexIDs);
  out << ", " << "resultValues=" << to_string(resultValues);
  out << ")";
}
...
void VertexResult::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "VertexResult(";
  out << "vertexID=" << to_string(vertexID);
  out << ", " << "resuls=" << to_string(resuls);
  out << ")";
}
...
void rvGetResultFromVerticesID_B::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetResultFromVerticesID_B(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "vertexResults=" << to_string(vertexResults);
  out << ")";
}
...
void ModelInfo::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "ModelInfo(";
  out << "name=" << to_string(name);
  out << ", " << "repository=" << to_string(repository);
  out << ", " << "owner=" << to_string(owner);
  out << ", " << "created=" << to_string(created);
  out << ", " << "accessRights=" << to_string(accessRights);
  out << ", " << "administrators=" << to_string(administrators);
  out << ", " << "underlyingSchema=" << to_string(underlyingSchema);
  out << ", " << "nObjectsInModel=" << to_string(nObjectsInModel);
  out << ", " << "dataSize=" << to_string(dataSize);
  out << ", " << "stringEncoding=" << to_string(stringEncoding);
...
void FullyQualifiedModelName::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "FullyQualifiedModelName(";
  out << "name=" << to_string(name);
  out << ", " << "full_path=" << to_string(full_path);
  out << ", " << "modelID=" << to_string(modelID);
  out << ", " << "location=" << to_string(location);
  out << ")";
}
...
void rvGetListOfModels::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvGetThumbnailOfAModel::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvOpenModel::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvOpenModel(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "modelID=" << to_string(modelID);
  out << ", " << "model_info=" << to_string(model_info);
  out << ")";
}
...
void rvGetListOfAnalyses::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetListOfAnalyses(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "analyses=" << to_string(analyses);
  out << ")";
}
...
void rvGetListOfTimeSteps::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetListOfTimeSteps(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "time_steps=" << to_string(time_steps);
  out << ")";
}
...
void rvGetListOfMeshes::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetListOfMeshes(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "meshInfos=" << to_string(meshInfos);
  out << ")";
}
...
void rvGetListOfResults::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvGetListOfVerticesFromMesh::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetListOfVerticesFromMesh(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "vertex_list=" << to_string(vertex_list);
  out << ")";
}
...
void rvGetResultFromVerticesID::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
void rvGetCoordinatesAndElementsFromMesh::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "rvGetCoordinatesAndElementsFromMesh(";
  out << "status=" << to_string(status);
  out << ", " << "report=" << to_string(report);
  out << ", " << "vertex_list=" << to_string(vertex_list);
  out << ", " << "element_list=" << to_string(element_list);
  out << ", " << "element_attrib_list=" << to_string(element_attrib_list);
  out << ", " << "element_group_info_list=" << to_string(element_group_info_list);
  out << ")";
}
