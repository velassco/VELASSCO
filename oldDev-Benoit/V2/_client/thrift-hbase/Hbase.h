...
class Hbase_getTableRegions_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "4B7A132DA1A7356BF16727D2452DC701";
  static const uint8_t binary_fingerprint[16]; // = {0x4B,0x7A,0x13,0x2D,0xA1,0xA7,0x35,0x6B,0xF1,0x67,0x27,0xD2,0x45,0x2D,0xC7,0x01};
...
class Hbase_getVerTs_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "3ECE05F16DC0058F49516C6ABCC3745E";
  static const uint8_t binary_fingerprint[16]; // = {0x3E,0xCE,0x05,0xF1,0x6D,0xC0,0x05,0x8F,0x49,0x51,0x6C,0x6A,0xBC,0xC3,0x74,0x5E};
...
class Hbase_getRow_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "F81F6ECB3DC785606052880ED76A17AD";
  static const uint8_t binary_fingerprint[16]; // = {0xF8,0x1F,0x6E,0xCB,0x3D,0xC7,0x85,0x60,0x60,0x52,0x88,0x0E,0xD7,0x6A,0x17,0xAD};
...
class Hbase_getRowWithColumnsTs_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "F7EE37A7E6C550ED1AE8E3FF73FA5407";
  static const uint8_t binary_fingerprint[16]; // = {0xF7,0xEE,0x37,0xA7,0xE6,0xC5,0x50,0xED,0x1A,0xE8,0xE3,0xFF,0x73,0xFA,0x54,0x07};
...
class Hbase_mutateRow_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "9F3EC4D14762581AF9F0BD5DD8B7B2AA";
  static const uint8_t binary_fingerprint[16]; // = {0x9F,0x3E,0xC4,0xD1,0x47,0x62,0x58,0x1A,0xF9,0xF0,0xBD,0x5D,0xD8,0xB7,0xB2,0xAA};
...
class Hbase_mutateRowTs_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "662552D88C7ADABA0500629AEB463016";
  static const uint8_t binary_fingerprint[16]; // = {0x66,0x25,0x52,0xD8,0x8C,0x7A,0xDA,0xBA,0x05,0x00,0x62,0x9A,0xEB,0x46,0x30,0x16};
...
class Hbase_mutateRows_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "C300BE7CA448C2B702E696CAD2365DD2";
  static const uint8_t binary_fingerprint[16]; // = {0xC3,0x00,0xBE,0x7C,0xA4,0x48,0xC2,0xB7,0x02,0xE6,0x96,0xCA,0xD2,0x36,0x5D,0xD2};
...
class Hbase_mutateRowsTs_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "C6ECE3E95E85B022C88490EDB58182E1";
  static const uint8_t binary_fingerprint[16]; // = {0xC6,0xEC,0xE3,0xE9,0x5E,0x85,0xB0,0x22,0xC8,0x84,0x90,0xED,0xB5,0x81,0x82,0xE1};
...
class Hbase_scannerOpenWithStopTs_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "BF8A69F4EC66692822161C0DC7EA9F55";
  static const uint8_t binary_fingerprint[16]; // = {0xBF,0x8A,0x69,0xF4,0xEC,0x66,0x69,0x28,0x22,0x16,0x1C,0x0D,0xC7,0xEA,0x9F,0x55};
...
class Hbase_scannerGet_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "3990F569750B199A59A44E2B0D4B1E59";
  static const uint8_t binary_fingerprint[16]; // = {0x39,0x90,0xF5,0x69,0x75,0x0B,0x19,0x9A,0x59,0xA4,0x4E,0x2B,0x0D,0x4B,0x1E,0x59};
