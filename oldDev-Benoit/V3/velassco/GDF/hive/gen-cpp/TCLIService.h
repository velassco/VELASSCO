...
class TCLIService_FetchResults_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "DB586720854D59267646B320F4BF094C";
  static const uint8_t binary_fingerprint[16]; // = {0xDB,0x58,0x67,0x20,0x85,0x4D,0x59,0x26,0x76,0x46,0xB3,0x20,0xF4,0xBF,0x09,0x4C};
...
class TCLIService_GetLog_result {
 public:
  ...
  static const char* ascii_fingerprint; // = "7CCAFBB0A15252AA4FC0CB07E8E70E2C";
  static const uint8_t binary_fingerprint[16]; // = {0x7C,0xCA,0xFB,0xB0,0xA1,0x52,0x52,0xAA,0x4F,0xC0,0xCB,0x07,0xE8,0xE7,0x0E,0x2C};
