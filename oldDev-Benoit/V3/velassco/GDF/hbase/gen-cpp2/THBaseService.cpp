        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->gets.resize(_size141);
            uint32_t _i145;
            for (_i145 = 0; _i145 < _size141; ++_i145)
            {
              xfer += this->gets[_i145].read(iprot);
            }
...
uint32_t THBaseService_getMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gets", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter146 = this->gets.begin(); _iter146 != this->gets.end(); ++_iter146)
    {
...
uint32_t THBaseService_getMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("gets", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter147 = (*(this->gets)).begin(); _iter147 != (*(this->gets)).end(); ++_iter147)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->puts.resize(_size159);
            uint32_t _i163;
            for (_i163 = 0; _i163 < _size159; ++_i163)
            {
              xfer += this->puts[_i163].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_puts = true;
...
uint32_t THBaseService_putMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("puts", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter164 = this->puts.begin(); _iter164 != this->puts.end(); ++_iter164)
    {
...
uint32_t THBaseService_putMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("puts", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter165 = (*(this->puts)).begin(); _iter165 != (*(this->puts)).end(); ++_iter165)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->deletes.resize(_size166);
            uint32_t _i170;
            for (_i170 = 0; _i170 < _size166; ++_i170)
            {
              xfer += this->deletes[_i170].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
          isset_deletes = true;
...
uint32_t THBaseService_deleteMultiple_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deletes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter171 = this->deletes.begin(); _iter171 != this->deletes.end(); ++_iter171)
    {
...
uint32_t THBaseService_deleteMultiple_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("deletes", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter172 = (*(this->deletes)).begin(); _iter172 != (*(this->deletes)).end(); ++_iter172)
    {
...
uint32_t THBaseService_append_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("append", ::apache::thrift::protocol::T_STRUCT, 2);
...
void THBaseServiceClient::append(TResult& _return, const std::string& table, const TAppend& append)
{
  send_append(table, append);
  recv_append(_return);
}

void THBaseServiceClient::send_append(const std::string& table, const TAppend& append)
{
  int32_t cseqid = 0;
...
void THBaseServiceClient::getScannerResults(std::vector<TResult> & _return, const std::string& table, const TScan& scan, const int32_t numRows)
{
  send_getScannerResults(table, scan, numRows);
  recv_getScannerResults(_return);
}

void THBaseServiceClient::send_getScannerResults(const std::string& table, const TScan& scan, const int32_t numRows)
{
  int32_t cseqid = 0;
...
void THBaseServiceProcessor::process_append(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->append(result.success, args.table, args.append);
    result.__isset.success = true;
  } catch (TIOError &io) {
    result.io = io;
    result.__isset.io = true;
...
void THBaseServiceProcessor::process_getScannerResults(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getScannerResults(result.success, args.table, args.scan, args.numRows);
    result.__isset.success = true;
  } catch (TIOError &io) {
    result.io = io;
    result.__isset.io = true;
