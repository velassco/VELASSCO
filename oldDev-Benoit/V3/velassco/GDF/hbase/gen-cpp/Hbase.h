...
class Hbase_scannerOpenWithScan_args {
 public:
  ...
  static const char* ascii_fingerprint; // = "F7FF4D2161E623FBF3FD29522176A9B9";
  static const uint8_t binary_fingerprint[16]; // = {0xF7,0xFF,0x4D,0x21,0x61,0xE6,0x23,0xFB,0xF3,0xFD,0x29,0x52,0x21,0x76,0xA9,0xB9};
