...
const char* TScan::ascii_fingerprint = "62155223232E7F826B261E31F58AE540";
const uint8_t TScan::binary_fingerprint[16] = {0x62,0x15,0x52,0x23,0x23,0x2E,0x7F,0x82,0x6B,0x26,0x1E,0x31,0xF5,0x8A,0xE5,0x40};
...
IOError::IOError(const IOError& other44) {
...
IllegalArgument::IllegalArgument(const IllegalArgument& other46) {
...
AlreadyExists::AlreadyExists(const AlreadyExists& other48) {
